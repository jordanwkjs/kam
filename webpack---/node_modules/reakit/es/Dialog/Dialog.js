...
function useHideOnClickOutside(dialogRef, disclosuresRef, nestedDialogs, options) {
    ...
    useEventListenerOutside(dialogRef, disclosuresRef, nestedDialogs, "mousedown", function(event) {
